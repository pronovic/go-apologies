...
import (
	identifier "github.com/pronovic/go-apologies/internal/identifier"
...
func (_m *MockMoveGenerator) Factory() identifier.Factory {
	ret := _m.Called()
	...
	var r0 identifier.Factory
	if rf, ok := ret.Get(0).(func() identifier.Factory); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(identifier.Factory)
		}
	}
